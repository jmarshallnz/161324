...
We'll be using the same data as Workshop 4 on computer perforamnce. Recall that we are interested in predicting the target `usr` as a function of the other variables.
